      ...
      <div className="mx-auto flex max-w-3xl items-end gap-2">
        <div className="flex-1 rounded-xl border border-border-light bg-surface">
          <textarea
            ...
            placeholder="Message Manticode..."
            rows={1}
            className="max-h-40 w-full resize-none bg-transparent px-3 py-2.5 text-sm text-text-primary placeholder:text-text-tertiary outline-none"
          />
        </div>
